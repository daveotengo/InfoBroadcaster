object Dependencies {
    ...
    val lifecycleViewModelKtx by lazy {"androidx.lifecycle:lifecycle-Viewnodel-ktx:${Versions.lifecycleViewModelKtx}" }
    ...
    val coroutinesAndrdid by lazy { "org.jetbrains.kotlinx:kotlinx-coroutines-android:${Versions.coroutines}"}
